...
module.exports = {
    ...
    session_secret: 'sodagames_session_secret', // 务必修改
...
//    站点基础信息配置
    ...
    DATABACKFORDER : '/usr/local/mongodb/mongodata/', // 服务端数据备份目录
    MONGODBEVNPATH : '/usr/local/bin', // LINUXmongodb环境变量(win server下不用管)
